...
// for creating event POST /badges-event/event  
    ...
    router.post('/', async (req, res) => {
      try {
        ...
        const response = await axios$1.post(`${API_BASE_URL}/api/v1/events`, eventData, {
          headers: {
            'Content-Type': 'application/json'
          }
        });
...
const hooks = [];const endpoints = [{name:'badge-event',config:e0},{name:'badge-user',config:e1}];const operations = [];
